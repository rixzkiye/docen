...
const translations = new Map<string, Record<string, string>>([
  [
    "en",
    {
      ...
      "ruler.topMargin": "Top Margin",
      "ruler.bottomMargin": "Bottom Margin",
      "ruler.tabStop": "Tab Stop",
      "ruler.tab.left": "Left Tab",
      "ruler.tab.center": "Center Tab",
      "ruler.tab.right": "Right Tab",
      "ruler.tab.decimal": "Decimal Tab",
      "ruler.tab.bar": "Bar Tab",
  ...
  [
    "zh-CN",
    {
      ...
      "ruler.topMargin": "上边距",
      "ruler.bottomMargin": "下边距",
      "ruler.tabStop": "制表位",
      "ruler.tab.left": "左对齐制表符",
      "ruler.tab.center": "居中制表符",
      "ruler.tab.right": "右对齐制表符",
      "ruler.tab.decimal": "小数点对齐制表符",
      "ruler.tab.bar": "竖线对齐制表符",
